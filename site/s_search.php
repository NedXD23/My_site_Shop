...
if(isset ($_POST['foo']))
{
  ...
  $query = "SELECT product_id,product_title, produtc_img1, product_price FROM produtcs WHERE product_keywords='".$caut."' and( p_nivel='".$_POST['foo']."'
   or p_marime='".$_POST['foo']."'   or p_sex='".$_POST['foo']."'  or p_stil='".$_POST['foo']."'  or p_producator='".$_POST['foo']."') ";
 
   
}
else{
$query = "SELECT product_id,product_title, produtc_img1, product_price FROM produtcs WHERE product_keywords='".$caut."' ";
}
