                     ...
                     <table class="table table-bordered">  
                          ...
                          <tr>  
                               ...
                               <td for='canti'>
                                                  ...
                                                  <select name="canti" id="canti">
                                    <option value="<?php echo $row["p_quantity"]; ?>"><?php echo $row["p_quantity"]; ?></option>
                                    ...
                                    <option  value="5">5</option>
                                        ...
                                        <input  type="submit" formmethod='post' formaction='modif.php' class="text-danger btn" value="Modify">
                              ...
                              $new_c=$row["p_quantity"] ;
                               ...
                               <td> <form method='POST'> <input type='hidden' class='btn' name='Pro' value='<?php echo $row["p_title"];  ?>' >
                                <input  type="submit" formmethod='post' formaction='del.php' class="text-danger btn" value="Remove">
                               </form>
                                                                  </td>  
                          </tr>  
                          <?php  
                          ...
                          <tr>  
                               ...
                               <td><form method='POST'><input  type="submit" formmethod='post' formaction='check_out.php' class="btn btn-success" value="CHECK OUT"> </form></td>  
                          </tr>  
                          <?php  
                          }  
                          ?>  
